...
/**
* @callback ServerEnvelopeSigner
* @param {String} envelope The envelope to sign
* @param {ServerEnvelopeSignerOptions} options
* @param {NodeCallback} callback
*/

/**
* @typedef {Object} ServerEnvelopeSignerOptions
...
* @param {ServerEnvelopeSigner} signer Signer to sign an envelope
*/
...
* Sign an envelope
* @param {String} envelope The envelope to sign
* @param {ServerEnvelopeSignerOptions} options Options to pass to the signer
* @param {NodeCallback} callback Function to be called once the envelope is signed
*/
Server.prototype._sign = function(envelope, options, callback) {
...
Server.prototype._processPOST = function(req,res) {
  ...
  function sign(result, statusCode, requestOptions) {
    self._sign(result, requestOptions, function(error,result){
  ...
  function onRequestBody(xml){
    try {
      self._process(xml, req.url, sign);
    }
    catch (err) {
      sendError(err);
    }
