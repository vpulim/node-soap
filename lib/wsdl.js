...
WSDL.prototype.findParameterObject = function(xmlns, parameterType, name) {
  ...
  if (this.definitions.schemas) {
    ...
    if (schema) {
      ...
      parameterTypeObj = schema.complexTypes[parameterType] || schema.elements[parameterType] || schema.elements[name];
    }
  }
...
WSDL.prototype.objectToDocumentXML = function(name, params, ns, xmlns, type) {
  var args = {};
  args[name] = params;
  var parameterTypeObj = type ? this.findParameterObject(xmlns, type, name) : null;
