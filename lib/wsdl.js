...
SchemaElement.prototype.merge = function(source) {
  ...
  //fix:java cxf export,wsdl:import use namespace,but match $targetnamespace
  if (this.$targetNamespace === source.$targetNamespace  || this.namespace === source.$targetNamespace || this.$targetNamespace === source.namespace) {
