...
DefinitionsElement.prototype.addChild = function(child) {
  ...
  } else if (child instanceof DocumentationElement) {} else if (child.name === 'import' || child.name === 'include') {
...
MessageElement.prototype.postProcess = function(definitions) {
  ...
  if (part.$element) {
    ...
    if (typeof definitions.schemas[definitions.xmlns[ns]] !== 'undefined') {
...
WSDL.prototype.objectToXML = function(obj, name, namespace, xmlns, first, xmlnsAttr, parameterTypeObject, ancestorXmlns) {
  ...
  var xmlnsAttrib = first ? ((namespace !== 'xmlns' ? ' xmlns:' + namespace + '="' + xmlns + '"' : '') + ' xmlns="' + xmlns + '"') : '';
