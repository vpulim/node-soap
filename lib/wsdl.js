...
WSDL.prototype.xmlToObject = function(xml) {
  var self = this;
  var parser = self.options.parser || 'expat';
  var p = (parser === 'expat' ? new expat.Parser('UTF-8') : sax.parser(true));
  var objectName = null;
  var root = {};
  var schema = {
    Envelope: {
...
WSDL.prototype._parse = function(xml) {
  var self = this,
    parser = self.options.parser || 'expat',
    p = (parser === 'expat' ? new expat.Parser('UTF-8') : sax.parser(true)),
    stack = [],
    root = null;
