...
// attribute
var AttributeElement = Element.createSubClass();
...
var ElementTypeMap = {
  ...
  complexType: [ComplexTypeElement,  'annotation sequence all complexContent simpleContent choice attribute'],
...
ComplexTypeElement.prototype.description = function(definitions, xmlns) {
  ...
  for (var i=0, child; child=children[i]; i++) {
    if( child instanceof AttributeElement){
      ...
      ret.$attributes[child.$name] = child.$type;
    }
      ...
      child instanceof ComplexContentElement)
    {
      ...
      if(hasAttributes){
        ret = Object.assign({}, child.description(definitions, xmlns), ret);
      } else{
