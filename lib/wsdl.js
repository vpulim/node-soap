...
WSDL.prototype.useBaseNameSpace = true;
...
WSDL.prototype._initializeOptions = function (options) {
  ...
  var useBaseNameSpace = options ? options.useBaseNameSpace : null;
  if(useBaseNameSpace)
    this.options.useBaseNameSpace = useBaseNameSpace;
  else
    this.options.useBaseNameSpace = this.useBaseNameSpace;
};
        ...
        if (self.definitions.schemas) {
          if (schema) {
            ...
            if (childParameterTypeObject && childParameterTypeObject.$type && (childParameterTypeObject.$type.indexOf('xsd') === -1)) {
               ...
               */
              if(childParameterTypeObject.$baseNameSpace && this.options.useBaseNameSpace) {
