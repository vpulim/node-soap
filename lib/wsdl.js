...
WSDL.prototype.xmlToObject = function(xml, callback) {
  ...
  p.onclosetag = function(nsName) {
    ...
    // SUPER HACK
    // topObject is sometimes a String instead of an Object which caused a runtime error, 
    // what would make the response not be parsed to Object returning instead a String
    if (typeof topObject === 'string') {
      topObject = {};
    }
