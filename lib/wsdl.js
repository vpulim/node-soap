...
var WSDL = function(definition, uri, options) {
  ...
  // Store date time parsing settings.
  self.momentDateTimeFormat = options.momentDateTimeFormat;
  self.overrideTimeZone = options.overrideTimeZone;
...
WSDL.prototype.xmlToObject = function(xml) {
  ...
  p.ontext = function(text) {
    ...
    if (name === 'int' || name === 'integer') {
      ...
      value = utils.parseDate(text, text, self.momentDateTimeFormat, self.overrideTimeZone);
    } else {
