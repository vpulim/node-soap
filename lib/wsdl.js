...
var InputElement = function() { Element.apply(this, arguments); }
var OutputElement = function() { Element.apply(this, arguments); }
...
var OperationElement = function(stack) { 
    Element.apply(this, arguments);
    this.input = null;
    this.output = null;
    if(stack[stack.length-1].name === 'binding') {
        this.style = '';
        this.soapAction = '';
    }
}
...
BindingElement.prototype.postProcess = function(definitions) {
    ...
    for (var i=0, child; child=children[i]; i++) {
        if (child.name != 'operation') continue;
        this.methods_soap[child.$name] = child;
