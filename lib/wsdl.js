...
var FaultElement = Element.createSubClass();
...
var AnnotationElement = Element.createSubClass();
var DocumentationElement = Element.createSubClass();
var DescriptionElement = Element.createSubClass();
...
var ElementTypeMap = {
    ...
    schema: [SchemaElement, 'element complexType simpleType include import annotation documentation removedType'],
    element: [ElementElement, 'annotation complexType simpleType minInclusive maxInclusive restriction'],
    simpleType: [SimpleTypeElement, 'enumeration annotation documentation description restriction'],
    complexType: [ComplexTypeElement,  'annotation sequence complexContent extension all'],
    ...
    fault : [FaultElement, 'documentation fault'],
    definitions: [DefinitionsElement, 'types message portType binding service documentation release'],
    annotation: [AnnotationElement, 'documentation version description'],
    documentation: [DocumentationElement, ''],
    description: [DescriptionElement, ''],
    enumeration: [EnumerationElement, 'annotation documentation description'],
    restriction: [RestrictionElement, 'enumeration annotation documentation description pattern maxLength minLength minInclusive maxInclusive'],
    complexContent: [ComplexContentElement, 'extension sequence element annotation documentation description' ],
    extension: [ExtensionElement, 'constraints sequence element annotation documentation description' ],
    part: [PartElement, 'documentation description' ]
};
...
TypesElement.prototype.addChild = function(child) {
    ...
    if(child.includes){
        child.includes.forEach(function(include){
            if(!this.schemas[include.namespace]){
                this.schemas[include.namespace]=new SchemaElement('schema');
            }
        })
    }
}
...
DefinitionsElement.prototype.addChild = function(child) {
    ...
    if (child instanceof TypesElement) {
        ...
        throw new Error('Invalid child type:'+child.name);
    }
    this.children.pop();
}
