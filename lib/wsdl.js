...
WSDL.prototype.objectToXML = function(obj, name, nsPrefix, nsURI, isFirst, xmlnsAttr, schemaObject, nsContext) {
  ...
  if (Array.isArray(obj)) {
    ...
    for (name in obj) {
      ...
      if (isFirst) {
        value = self.objectToXML(child, name, nonSubNameSpace || nsPrefix, nsURI, false, null, schemaObject, nsContext);
      } else {
        ...
        if (self.definitions.schemas) {
          if (schema) {
            ...
            if (childSchemaObject &&
              ...
              value = self.objectToXML(child, name, nonSubNameSpace || nsPrefix, nsURI, false, null, null, nsContext);
            }
          } else {
            value = self.objectToXML(child, name, nonSubNameSpace || nsPrefix, nsURI, false, null, null, nsContext);
          }
