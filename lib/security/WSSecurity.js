...
WSSecurity.prototype.toXML = function() {
  ...
  if (this._passwordType === 'PasswordText') {
    password = "<wsse:Password Type=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText\">" + wrapInCdata(this._password) + "</wsse:Password>";
    if (nonce) {
  ...
  return "<wsse:Security " + (this._actor ? "soap:actor=\"" + this._actor + "\" " : "") +
    ...
    "<wsse:Username>" + wrapInCdata(this._username) + "</wsse:Username>" +
    password +
