 ...
 *
 * Combine with WS security
 *
 */
function ClientSSLWSSecurity(username, password, options, key, cert, ca, defaults) {
    options = options || {};
...
ClientSSLWSSecurity.prototype.toXML = function(headers) {
...
ClientSSLWSSecurity.prototype.addOptions = function(options) {
...
module.exports = ClientSSLWSSecurity;
