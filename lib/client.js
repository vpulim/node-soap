...
/**
* @callback ClientEnvelopeSigner
* @param {String} envelope The envelope to sign
* @param {ClientEnvelopeSignerOptions} options
* @param {NodeCallback} callback
*/

/**
* @typedef {Object} ClientEnvelopeSignerOptions
* @property {*} args
...
/**
* Add an envelope signer
* @param {ClientEnvelopeSigner} signer Signer to sign an envelope
*/
Client.prototype.addSigner = function(signer) {
...
* Sign an envelope
* @param {String} envelope The envelope to sign
* @param {ClientEnvelopeSignerOptions} options Options to pass to the signer
* @param {NodeCallback} callback Function to be called once the envelope is signed
*/
Client.prototype._sign = function(envelope, options, callback) {
  sign(this._signers, envelope, options, callback);
};
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  self._sign(xml, signOptions, function(error, xml){
    if( error ) {
      return callback(error, null, null);
    }
    self._makeRequest(location, xml, headers, options, method, callback);
  });
};

Client.prototype._makeRequest = function(location, xml, headers, options, method, callback) {

  var self = this,
    req,
    name = method.$name,
    output = method.output;
  req = self.httpClient.request(location, xml, onResponse, headers, options, self);
