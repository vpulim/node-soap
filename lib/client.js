...
Client.prototype._defineMethod = function(method, location) {
  var self = this;
  var temp;
  var func = function(args, callback, options, extraHeaders) {
  ...
  func.describe = function() {
    return self._describeMethod(method);
  }
  return func;
};
...
Client.prototype._describeMethod = function(method) {
  return method.description(this.wsdl.definitions);
}
