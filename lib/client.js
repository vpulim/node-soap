...
Client.prototype.setAttributesNamespace = function (namespace) {
  this.wsdl.options.attributesNamespace = namespace;
};
...
Client.prototype._initializeOptions = function(options) {
  if (options.attributesNamespace) {
    this.setAttributesNamespace(options.attributesNamespace);
  } else {
    this.setAttributesNamespace('');
  }
};
