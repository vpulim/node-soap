...
describe('WSSecurity', function() {
  ...
  it('should insert a WSSecurity when postProcess is called', function() {
    var username = 'special&<<>>Characters]]>username</wsse:Username>';
    var password = 'even&>><<"moreSpecial]]>password';
    var options = {
      passwordType: 'PassWordText',
      hasNonce: true,
      actor: 'urn:sample'
    ...
    xml.should.containEql('<wsse:Username><![CDATA[special&<<>>Characters]]]]><![CDATA[>username</wsse:Username>]]></wsse:Username>');
    ...
    xml.should.containEql('<![CDATA[even&>><<"moreSpecial]]]]><![CDATA[>password]]></wsse:Password>');
